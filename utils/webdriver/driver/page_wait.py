...
from utils.types.webdriver.driver.page_wait import (
    PageWaitInterface,
    WebDriverUntilMethod,
)
...
class PageWait(PageWaitInterface):
    def __init__(
        ...
        self._wait = WebDriverWait(
            driver=webdriver, timeout=timeout, ignored_exceptions=ignored_exceptions
        )
    ...
    def build(
        ...
        return WebDriverWait(
            self._webdriver, timeout, ignored_exceptions=ignored_exceptions
        )
