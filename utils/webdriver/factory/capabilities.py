...
def build_capabilities(browser: Browser, capabilities: Capabilities | None) -> Capabilities:
    ...
    match browser:
        case Browser.CHROME:
            _capabilities.update(webdriver.DesiredCapabilities.CHROME.copy())
        case     Browser.FIREFOX:
            _capabilities.update(webdriver.DesiredCapabilities.FIREFOX.copy())
        case _:
            raise ValueError(
    ...
    if capabilities:
        _capabilities.update(_capabilities)
